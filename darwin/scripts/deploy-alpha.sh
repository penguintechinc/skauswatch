#!/usr/bin/env bash
# =============================================================================
# darwin Alpha Deployment Script
...
#   NAMESPACE             Target namespace (default: darwin-alpha)
#   APP_HOST              Application hostname (default: darwin.localhost.local)
#
# NOTE: kustomization.yaml may reference project-template-alpha; darwin-alpha
#       is the correct namespace (template artifact — do not change here).
#
# =============================================================================
...
readonly APP_NAME="${APP_NAME:-darwin}"
readonly KUBE_CONTEXT="${KUBE_CONTEXT:-local-alpha}"
readonly NAMESPACE="${NAMESPACE:-darwin-alpha}"
readonly APP_HOST="${APP_HOST:-darwin.localhost.local}"

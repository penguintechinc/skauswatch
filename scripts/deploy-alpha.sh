#!/usr/bin/env bash
# =============================================================================
# SkausWatch Alpha Deployment Script
...
#   NAMESPACE             Target namespace (default: skauswatch-alpha)
#   APP_HOST              Application hostname (default: skauswatch.localhost.local)
#
# =============================================================================
...
readonly APP_NAME="${APP_NAME:-skauswatch}"
readonly KUBE_CONTEXT="${KUBE_CONTEXT:-local-alpha}"
readonly NAMESPACE="${NAMESPACE:-skauswatch-alpha}"
readonly APP_HOST="${APP_HOST:-skauswatch.localhost.local}"

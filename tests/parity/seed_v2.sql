...
-- Rust manager's sqlx queries expect. See docs/MIGRATION.md for the full
-- module rename map.
--
...
INSERT INTO alerts (id, title, description, severity, status, source, indicators, ai_review, assigned_to, resolved_at, resolution_notes, created_at, updated_at) VALUES
 (1, 'C2 beacon detected',        'Endpoint beaconing to a known C2 host.',  'critical', 'pending',        'endpoint',    '["203.0.113.7"]',        NULL, NULL, NULL,                  NULL,             '2026-06-15 09:00:00',        NULL),
 ...
 (4, 'Port scan (benign)',        'Internal scanner traffic.',               'info',     'false_positive', 'endpoint',    '[]',                     NULL, NULL, NULL,                  NULL,             '2026-06-15 11:00:00',        NULL);
...
INSERT INTO endpoint_agents (id, agent_id, hostname, ip_address, os_type, os_version, agent_version, status, last_heartbeat, metadata, created_at, updated_at) VALUES
...
INSERT INTO endpoint_events (id, agent_id, event_type, severity, process_name, process_path, process_hash, parent_process, command_line, network_connections, file_operations, registry_operations, details, created_at) VALUES

...
- **Alpha:** `https://vault.skauswatch.localhost.local/api/v1`
- **Beta:** `https://vault.skauswatch.penguintech.cloud/api/v1`
- **Production:** `https://vault.skauswatch.app/api/v1`
...
```json
{
  ...
  "data": {
    ...
    "share_url": "https://vault.skauswatch.app/api/v1/one-time-secrets/ots:abcd1234efgh5678ijkl9012mnop3456"
  }
}
```

...
Initial release of Darwin as a licensed sub-module for SkausWatch.
...
- ⚙️ **Enterprise Features**
  ...
  - Feature gating (`darwin` license feature)
...
Darwin was built by the Penguin Tech Inc engineering team.
...
Darwin is a licensed feature under SkausWatch.

**License Types:**
- ✅ Community Edition: Not available
- ✅ Enterprise Edition: Included (requires `darwin` feature)

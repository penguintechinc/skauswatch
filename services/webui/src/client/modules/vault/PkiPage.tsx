...
export default function PkiPage() {
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const res = await apiVault.get<ApiResponse<PkiSummary>>('/api/v1/pki/summary');
  ...
  return (
    <div>
      ...
      <p className="text-slate-400 text-sm mb-6">
        Certificate lifecycle is managed by the Vault PKI service. This dashboard shows a summary.
      </p>

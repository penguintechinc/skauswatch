...
export default function SshPage() {
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const res = await apiVault.get<ApiResponse<SshSummary>>('/api/v1/ssh/summary');
  ...
  return (
    <div>
      ...
      <p className="text-slate-400 text-sm mb-6">
        SSH certificates are managed by the Vault SSH CA service. This dashboard shows a summary.
      </p>

...
//! docs/v2-port/log-receiver-contract.md). Present-but-unused env vars do not
//! affect startup.
...
/// Default HTTP ingest port (v1 default; the `LOG_RECEIVER_URL` the manager
/// proxies to is `http://log-receiver:5010`).

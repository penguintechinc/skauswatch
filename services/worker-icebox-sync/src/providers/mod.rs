//! Cloud provider abstraction for IceBox↔cloud secret sync. Rust port of
...
pub struct SyncResult {
    /// IceBox secret id this operation was for.
...
/// invoked them either — the `cloud_to_icebox`/`bidirectional` pull-sync
...
pub trait CloudProvider: Send + Sync {
    ...
    /// Lists all IceBox-managed secret refs in this provider.
    #[allow(dead_code)]

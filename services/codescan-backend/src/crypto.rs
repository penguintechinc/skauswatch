...
//! (`codescan_git_credentials.encrypted_token`). Replaces the v1 Flask
...
impl CredentialCipher {
    ...
    ///
    /// Not called by this service today — codescan-backend only writes
    /// encrypted tokens; worker-codescan (a separate binary) is the consumer

...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "tenant_id",
            sa.Integer(),
            sa.ForeignKey("darwin_tenants.id"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "auto_review", sa.Boolean(), server_default=sa.text("TRUE"), nullable=False
        ),
        sa.Column(
            "is_active", sa.Boolean(), server_default=sa.text("TRUE"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "repo_config_id",
            sa.Integer(),
            sa.ForeignKey("darwin_repo_configs.id"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_darwin_reviews_repo_config_id", "darwin_reviews", ["repo_config_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "review_id",
            sa.Integer(),
            sa.ForeignKey("darwin_reviews.id"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_darwin_issue_plans_repo_config_id", "darwin_issue_plans", ["repo_config_id"]
    )

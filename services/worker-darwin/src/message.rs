//! Darwin review task message structures parsed from Redis streams.

use serde::{Deserialize, Serialize};
use skauswatch_streams::StreamEntry;

/// A Darwin review task from the `darwin:tasks` stream.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct DarwinReviewTask {
...
/// Result of a code review (published to darwin:results stream).
#[derive(Debug, Clone, Serialize, Deserialize)]
#[allow(dead_code)]

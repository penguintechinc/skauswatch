...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "scan_metadata", sa.JSON().with_variant(sa.Text(), "sqlite"), nullable=True
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "result_summary", sa.JSON().with_variant(sa.Text(), "sqlite"), nullable=True
        ),
        sa.Column(
            "created_at", sa.DateTime(), nullable=False, server_default=sa.func.now()
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "cve_ids", sa.JSON().with_variant(sa.Text(), "sqlite"), nullable=True
        ),
        sa.Column(
            "cwe_ids", sa.JSON().with_variant(sa.Text(), "sqlite"), nullable=True
        ),
        sa.Column("evidence", sa.Text(), nullable=True),
        sa.Column(
            "raw_finding", sa.JSON().with_variant(sa.Text(), "sqlite"), nullable=True
        ),
        sa.Column(
            "status", sa.String(length=50), nullable=False, server_default="open"
        ),
        sa.Column(
            "discovered_at", sa.DateTime(), nullable=False, server_default=sa.func.now()
        ),
        sa.Column(
            "updated_at",
            sa.DateTime(),
    ...
    op.create_index(
        "idx_scan_schedules_enabled_next_run", "scan_schedules", ["enabled", "next_run"]
    )

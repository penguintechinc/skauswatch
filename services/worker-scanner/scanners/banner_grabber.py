...
def _guess_service(port: int) -> str:
    ...
    service_map = {
        ...
        2375: "docker", 2376: "docker-tls", 2379: "etcd", 3306: "mysql",
        3389: "rdp", 4369: "rabbitmq-epmd", 5432: "postgresql",
        5601: "kibana", 5672: "rabbitmq-amqp", 5900: "vnc", 5901: "vnc",
        5984: "couchdb", 6379: "redis", 6443: "k8s-api", 8080: "http-alt",
        8443: "https-alt", 8888: "jupyter", 9000: "minio", 9092: "kafka",

...
class ManagerConfig:
    ...
    def load_from_env(self) -> None:
        ...
        if os.getenv("SKAUSWATCH_SECURE_COOKIES"):
            self.security.secure_cookies = os.getenv("SKAUSWATCH_SECURE_COOKIES").lower() == "true"
    ...
    def _ensure_secrets(self) -> None:
        ...
        if not self.security.secret_key:
            ...
            self.security.secret_key = ''.join(secrets.choice(alphabet) for _ in range(64))
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "ui": self.ui.__dict__,
            "notification": {k: v for k, v in self.notification.__dict__.items()

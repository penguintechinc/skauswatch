...
class AlertManager:
    ...
    async def _evaluate_metric_against_rules(self, metric: Metric):
        ...
        for rule in self.alert_rules:
            ...
            alert_key = f"{rule['name']}_{metric.name}_{self._labels_to_key(metric.labels)}"
...
class PerformanceProfiler:
    ...
    def get_profile_stats(self, service: Optional[str] = None, operation: Optional[str] = None) -> Dict[str, Any]:
...
async def initialize_global_monitor(service_name: str, config: Optional[Dict[str, Any]] = None) -> PerformanceMonitor:
